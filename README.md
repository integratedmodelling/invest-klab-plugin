...
- Spatial Context: Vector Input - Path to the `.shp` file needs to be supplied. The supplied Geometry is updated to EPSG:4326 if not already in [WKT format](https://mapscaping.com/a-guide-to-wkt-in-gis/), WGS84 coordinate reference system: Example - `POLYGON((33.796 -7.086, 35.946 -7.086, 35.946 -9.41, 33.796 -9.41, 33.796 -7.086))`, and the same is set in k.LAB Engine and triggers the Observation of the specified semantic concept. 
